       ...
       try{
        ...
        String place2 = "community";
                        ...
                        try{
                            ...
                            String query01="update teachertable set deptid=?, qualification=? , desig=?,image=?,email=?,name=?,phone=?,dob=? where teacherid=?";
                            PreparedStatement myst01=myconnection.prepareStatement(query01);
                            myst01.setString(1, deptid);
                            myst01.setString(6, name);
                            myst01.setString(5, email);
                            myst01.setString(4, password);
                            myst01.setString(2, quali);
                            myst01.setString(7, phno);
                            myst01.setString(8, dob);
                            myst01.setString(9, request.getParameter("id"));
                            myst01.setString(4, image);
                            myst01.setString(3,desig);
