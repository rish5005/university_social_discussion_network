        ...
        if(request.getParameter("sub")!=null){
         ...
         try{
             ...
             try{
                 ...
                 String query1="insert into depttable(deptname,mneo) values(?,?)";
                 PreparedStatement myst1=myconnection.prepareStatement(query1);
                 myst1.setString(1,request.getParameter("deptname"));
                 myst1.setString(2,request.getParameter("deptmneo"));
                 ...
                 {
                     out.print("Department Not Added Successfully");
