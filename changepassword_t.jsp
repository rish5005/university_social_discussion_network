									...
									<div class="form-body form-body-info">
										<form method="post">
											<div class="form-group">
												...
												<input type="password" class="form-control" name="currpass" placeholder="Current Password" required="">
											</div>
                                                                                    <div class="form-group">
												...
												<input type="password" class="form-control" name="newpassc" placeholder=" Confirm New Password" required="">
											</div>
											<div class="form-group">
        ...
        if(request.getParameter("sub")!=null){
         ...
         try{
             ...
             try{
                 ...
                 String query1="select * from teachertable where teacherid=?";
                 PreparedStatement myst1=myconnection.prepareStatement(query1);
                 myst1.setString(1,session.getAttribute("teach_id").toString());
                 ResultSet myres1= myst1.executeQuery();
                 if(myres1.next())
                 {
                     d_pass = myres1.getString("password");
                     if(d_pass.equals(request.getParameter("currpass")))
                     {
                         if(request.getParameter("newpass").equals(request.getParameter("newpassc")))
                         {
                             String query2="update teachertable set password=? where teacherid=?";
                 PreparedStatement myst2=myconnection.prepareStatement(query2);
                 myst2.setString(1,request.getParameter("newpass"));
                 myst2.setString(2,session.getAttribute("teach_id").toString());
                 if(myst2.executeUpdate()>0)
                 {
                     out.print("Password Updated Successfully");
                             ...
                             out.print("Password Entered Are Not Same");
                         }
                 ...
                 {
                     out.print("Email with whichyou registered is not authenticated");
