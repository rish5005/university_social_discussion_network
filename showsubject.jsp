					...
					<%
                        ...
                        { 
                         ...
                         String place = "community";
                            ...
                            String query="select * from subtable, depttable, coursetable where subtable.deptid=depttable.deptid and subtable.courseid=coursetable.courseid order by depttable.deptid ";
                            ...
                            if(myres.next())
                            {
                                    out.print("<div class='w3l-table-info agile_info_shadow'>"
                                            + "<table class='table'>"
                                                                        + "<tr><th>Sr. No.</th><th>Department Name</th><th>Course Name</th><th>Semester</th><th>Subject Name</th><th>Subject Code</th><th>Type</th><th>Credits</th>"
                                    + "<th>Update</th><th>Delete</th></tr>");

                                do
                                {
                                   
                                    out.print("<tr><td>" +count +"</td><td>" + myres.getString("deptname")+"</td>"
                                            + "<td>"+myres.getString("coursename") +"</td>"
                                             + "<td>"+myres.getString("sems")+" Semester" +"</td>"
                                            + "<td>"+myres.getString("subname") +"</td>"
                                            +"<td>"+myres.getString("subcode") +"</td>"
                                            +"<td>"+myres.getString("type") +"</td>"
                                            +"<td>"+myres.getString("credits") +"</td>");
                                            
                                            
                                     out.print("<td><a  href='updatesubject.jsp?id=" + myres.getString("subid")+ "'><i  class='fa-2x  fa fa-edit' style='color:blue' ></i></a></td>"
                                            +"<td><a class='mylink' id='" + myres.getString("subid") + "' href='delcat.jsp'><i class='fa-2x fa fa-times-circle-o' style='color:red' aria-hidden='true'></i></a></td></tr>");
