          ...
          <div class="w3-card w3-round w3-theme-d4">
            <div class="w3-container w3-padding">
              ...
              <span>
                ...
                <% 
    String message="",path="",image1="",postpics="";
      ...
      if(successful==true)
        {
          ...
          try{
                           ...
                           try{
                               ...
                               String q1="insert into posttable(type,message,time,userid,image) values(?,?,?,?,?)";
                               ...
                               mystatement.setString(3, dat.toString());

                               mystatement.setString(4, session.getAttribute("email").toString());
                               mystatement.setString(5, session.getAttribute("image").toString());
                               
                               if(mystatement.executeUpdate()>0)
                               {
                                   out.print("Insertion successfull");
                                        ...
                                        try{
                                               ...
                                               if(myresult2.next())
                                                { 
                                                    ...
                                                    String q3="select * from rusers ";
                                                    PreparedStatement mystatement3=myconnection.prepareStatement(q3);                                               
                                                    ResultSet myresult3=mystatement3.executeQuery();
                                                    if(myresult3.next())
                                                    {
                                                        do{
                                                            String q4="insert into adminstudentnotificationtable(postid,adminid,studentid,status) values(?,?,?,?)";
                                                            PreparedStatement mystatement4=myconnection.prepareStatement(q4);
                                                            mystatement4.setString(1, myresult2.getString("postid"));
                                                            mystatement4.setString(2, session.getAttribute("email").toString());
                                                            mystatement4.setString(3, myresult3.getString("rno"));
                                                    ...
                                                    String q31="select * from teachertable ";
                                                    PreparedStatement mystatement31=myconnection.prepareStatement(q31);                                               
                                                    ResultSet myresult31=mystatement31.executeQuery();
                                                    if(myresult31.next())
                                                    {
                                                        do{
                                                            String q4="insert into adminteachernotificationtable(postid,adminid,teacherid,status) values(?,?,?,?)";
                                                            PreparedStatement mystatement4=myconnection.prepareStatement(q4);
                                                            mystatement4.setString(1, myresult2.getString("postid"));
                                                            mystatement4.setString(2, session.getAttribute("email").toString());
                                                            mystatement4.setString(3, myresult31.getString("teacherid"));
                                                            mystatement4.setString(4, "unread");
                                                            if(mystatement4.executeUpdate()>0)
                                                            {
...
%>
    ...
    try{
        ...
        try
        {
            String q="select * from posttable where userid=? and type=?";
            PreparedStatement mystatement=myconnection.prepareStatement(q);   
                                            ...
                                            if(myresult3.getInt("totalpics")==1)
                                            {
                                                if(myresult.getString("type").equals("admin"))
                                                {
                                                    ...
                                                    if(myresult4.next())
                                                    {
                                                        ...
                                                        out.print("</div>"
                                                      + "<a href='comment_a.jsp?pid="+ myresult.getString("postid") +"'<button type='button' class='w3-button w3-theme-d2 w3-margin-bottom'><i class='fa fa-comment'></i> &nbsp;Comment</button></a>  ");
                                            ...
                                            else
                                            {
                                                if(myresult.getString("type").equals("admin"))
                                                {
                                                    ...
                                                    if(myresult4.next())
                                                    {
                                                       ...
                                                       out.print("</div>"
                                                      + "<br><a href='comment_a.jsp?pid="+ myresult.getString("postid") +"'<button type='button' class='w3-button w3-theme-d2 w3-margin-bottom'><i class='fa fa-comment'></i> &nbsp;Comment</button></a>  ");
                                                      if(myresult.getString("userid").equals(session.getAttribute("email").toString()) && myresult.getString("type").equals("admin"))
                                                        {
                                                            out.print("<a class='mylink' id='" + myresult.getString("postid") + "' href='delcat.jsp'><button type='button' class='w3-button w3-theme-d1 w3-margin-bottom'><i class=' fa fa-trash' saria-hidden='true'></i> &nbsp;Delete</button></a> ");
                                                        }
