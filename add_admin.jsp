...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
											...
											<div class="form-group ">	
												...
												<input type="number" class="form-control" name="phno" placeholder="Contact Number" required="">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <select class="form-control" name="type"><option>Admin</option><option>Office</option></select>
											</div>
                                                                                    <div class="form-group">
           ...
           String deptid="", name="",email="",password="",pass5="",phno="",type1="",gender="",image="",path1;
       ...
       try{
        ...
        String place4 = "community";
                        ...
                        try{
                            ...
                            String query011="select * from admintable where email=?";
                            PreparedStatement myst011=myconnection.prepareStatement(query011);
                            myst011.setString(1,email);
                            ResultSet rs = myst011.executeQuery();
                            if(rs.next())
                            {
                                ...
                                if(password.equals(pass5))
       {
        ...
        String place2 = "community";
                        ...
                        try{
                            ...
                            String query01="insert into admintable values(?,?,?,?,?,?,?,?)";
                            PreparedStatement myst01=myconnection.prepareStatement(query01);
                            myst01.setString(1, deptid);
                            myst01.setString(2, name);
                            myst01.setString(3, password);
                            myst01.setString(4, type1);
                            myst01.setString(5, phno);
                            myst01.setString(6, email);
                            myst01.setString(7, gender);
                            myst01.setString(8, image);
                        ...
                        {
                         out.print("Error in query23"+e.getMessage());
                        }
                    }
                    catch(Exception e)
                        {
