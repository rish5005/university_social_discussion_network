...
%>
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info">
                                                                                   ...
                                                                                   <h3>Choose File(PDF format)</h3>
                                                                                   <h6>Note: Most Recent Assignment Would Be Considered For Evaluation</h6>
					  				...
					  				<div class="agile-tables">
                                                                            	<div class="w3l-table-info agile_info_shadow">
                                                                                    ...
                                                                                    %>
                                                                                    <%
                                                                                        String a[]=request.getParameter("no").split("_");
                                                                                        je=a[2];
                                                                                        se=a[0];
   ...
   for(FileItem myitem:items)
   {
        ...
        else
        {
                ...
                long size1234=myitem.getSize()/1024; //kbytes
                ...
                if(size1234==0)
                {
                    image=" ";
                        ...
                        || type.equals("image/gif") || type.equals("application/pdf")) && size1234<50000)
                    {
               ...
               myitem.write(savefile);    
                    ...
                    {
                        successful=false;
                        out.println("Sorry only pictures/pdf of less than 5Mb are allowed to upload");
                    }
   ...
   if(successful==true)
   {
      ...
      String query1010101010="select * from assignmenttable where assid=?";
                                    PreparedStatement myst101010101010=myconnection.prepareStatement(query1010101010);
                                    myst101010101010.setString(1, je);
                                    ResultSet myres2322=myst101010101010.executeQuery();
                                     if(myres2322.next())
                                     {
                                         ...
                                         curr_date=mydate.format(dat);
                                         String c_date[]=curr_date.split("-");
                                         
                                       
                                     
                                        String deadline;
                                        deadline=myres2322.getString("deadline");
                                        String f_date[]= deadline.split("-");
                      if(Integer.parseInt(f_date[0])>=Integer.parseInt(c_date[0]))
                                {
                                     if( Integer.parseInt(f_date[1])>Integer.parseInt(c_date[1]))
                                            {
                                                    String query01="insert into assignment_submission_table(assid,rno,name,sec,submission_date,assignment) values(?,?,?,?,?,?)";
                                                    PreparedStatement myst01=myconnection.prepareStatement(query01);
                                                    myst01.setString(1, je);
                                                    myst01.setString(2, session.getAttribute("rno").toString());
                                                    myst01.setString(3, session.getAttribute("name").toString());
                                                    myst01.setString(4, se);
                                                    myst01.setString(5, curr_date);
                                                    myst01.setString(6, image);
                                            ...
                                            else if(Integer.parseInt(f_date[1])==Integer.parseInt(c_date[1]))
                                                {
                                                    if(Integer.parseInt(f_date[2])>=Integer.parseInt(c_date[2]))
                                                    {
                                                            String query01="insert into assignment_submission_table(assid,rno,name,sec,submission_date,assignment) values(?,?,?,?,?,?)";
                                                            PreparedStatement myst01=myconnection.prepareStatement(query01);
                                                            myst01.setString(1, je);
                                                        ...
                                                        {
                                                            out.print("Cannot Submit After Deadline!!!! Contact Teacher ");
                                                        }
