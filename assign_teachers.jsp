...
<div class="wthree_agile_admin_info">
        ...
        if(request.getParameter("sub")!=null){
          ...
          if(!(request.getParameter("deptbox").trim().equals("")) && !(request.getParameter("course").trim().equals("")) && !(request.getParameter("year").trim().equals("")) && !(request.getParameter("semester").trim().equals(""))  && !(request.getParameter("subject").trim().equals(""))  && !(request.getParameter("teacher").trim().equals("")) && !(request.getParameter("section").trim().equals("")))
          {
        try{
             Connection myconnection;
             Class.forName("com.mysql.jdbc.Driver");
             ...
             try{
                 ...
                 String query1="insert into assignedsubjects(deptid,courseid,year,sem,subject,teacher,sec) values(?,?,?,?,?,?,?)";
                 PreparedStatement myst1=myconnection.prepareStatement(query1);
                 myst1.setString(1,request.getParameter("deptbox"));
                 myst1.setString(2,request.getParameter("course"));
                 myst1.setString(3,request.getParameter("year"));
                 myst1.setString(4,request.getParameter("semester"));
                 myst1.setString(5,request.getParameter("subject"));
                 myst1.setString(6,request.getParameter("teacher"));
                 myst1.setString(7,request.getParameter("section"));
                 ...
                 {
                     out.print("Section Not Added Successfully");
    ...
    $(document).ready(function(){
        $('#teacher').change(function(){
            ...
            $.ajax({
               url : 'ajax2.jsp',
               type : 'post',
               data :{"dptaa" : dept, "csid12" : courseid, "yr12" : admisyear},
