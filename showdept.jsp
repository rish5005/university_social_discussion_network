                         ...
                         String place = "community";
                            ...
                            if(myres.next())
                            {
                                    out.print( "<div class='w3l-table-info agile_info_shadow'>"
                                            + "<table class='table'>"
                                    + "<tr><th>Sr. No.</th><th>Department Name</th><th>Mnemonic</th><th>Head</th>"
                                    + "<th>No. Of Students</th><th>Update</th><th>Delete</th></tr>");

                                do
                                {
                                    
                                    String q="select * from teachertable where deptid=? and desig=? ";
                                    PreparedStatement mystatement1=myconnection.prepareStatement(q);
                                    mystatement1.setString(1, myres.getString("deptid"));
                                    mystatement1.setString(2,"Hod" );
                                    ResultSet myres1=mystatement1.executeQuery();
                                    

                                    String q2="select COUNT(rno) as nstudents from rusers where dept=?";
                                    PreparedStatement mystatement2=myconnection.prepareStatement(q2);
                                    mystatement2.setString(1, myres.getString("deptid"));
                                    ResultSet myres2=mystatement2.executeQuery();
                      
                                    
                                    
                                    out.print("<tr><td>"+count+"</td><td>" + myres.getString("deptname") 
                                    + "</td><td>" + myres.getString("mneo") + "</td>");
                                    
                                    if(myres1.next())
                                    {
                                        out.print("<td><img src='teacher_pics/"+myres1.getString("image")+"' width='60px' height='60px'><br>" + myres1.getString("name") + "</td>");
                                    }
                                    else
                                    {
                                        out.print("<td><img src='teacher_pics/default.png' width='60px' height='60px'><br>" + "HOD Not Assigned" + "</td>");
                                    }
                                    if(myres2.next())
                                    {
                                    out.print("<td>"+myres2.getString("nstudents")+"</td>");
                                    }
                                   
                                           out.print("<td><a  href='updatedept.jsp?id=" + myres.getString("deptid")+ "'><i  class='fa-2x  fa fa-edit' style='color:blue' ></i></a></td>"
