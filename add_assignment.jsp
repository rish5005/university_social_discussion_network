...
%>				                                                          
		...
		<!-- /inner_content-->
					...
					<div class="inner_content_w3_agile_info">
					  				...
					  				<div class="agile-tables">
											...
											<div class="form-group ">	
												...
												<input type="text" class="form-control" name="ass_topic" placeholder="Topic" required="">
											</div>
                                                                                            
                                                                                    
                                                                                        <div class="form-group ">
                                                                                            Deadline<br>
												<input type="Date" class="form-control" name="deadline" placeholder="Deadline" min="<%
           ...
           String subject="",topic="",deadline="",image="",sec="",path1;
   ...
   for(FileItem myitem:items)
   {
        if (myitem.isFormField())
        {
            ...
            if(itemName1.equals("subject")) //control's name - textbox name
           {
                subject = value;
           }
            else if(itemName1.equals("ass_topic")) //control's name - textbox name
           {
                topic = value;
            }
            else if(itemName1.equals("deadline")) //control's name - textbox name
           {
                deadline = value;
            }
        ...
        else
        {
                ...
                if(size==0)
                {
                    image=" ";
                        ...
                        || type.equals("image/gif") || type.equals("application/pdf")) && size<50000)
                    {
       ...
       try{
        ...
        String place2 = "community";
                        ...
                        try{
                            ...
                            String query01="insert into assignmenttable(teach_id,topic,deadline,assignment,subject,sec) values(?,?,?,?,?,?)";
                            PreparedStatement myst01=myconnection.prepareStatement(query01);
                            myst01.setString(1, session.getAttribute("teach_id").toString());
                            myst01.setString(2, topic);
                            myst01.setString(3, deadline);
                            myst01.setString(4, image);
                            myst01.setString(5, subject);
                            myst01.setString(6, sec);
