						...
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								<li><a href="add_admin.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Admin</a></li>
                                                                ...
                                                                <li><a href="showdept.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Show Department</a></li>
					...
					<%
                        ...
                        { 
                         ...
                         String place = "community";
                            ...
                            String query="select * from coursetable, depttable where coursetable.deptid=depttable.deptid order by depttable.deptid ";
                            ...
                            if(myres.next())
                            {
                                    out.print("<div class='w3l-table-info agile_info_shadow'>"
                                            + "<table class='table'>"
                                    + "<tr><th>Sr. No.</th><th>Department Name</th><th>Course name</th><th>Course Length</th>"
                                    + "<th>Semesters</th><th>Update</th><th>Delete</th></tr>");

                                do
                                {
                                   
                                    out.print("<tr><td>" +count +"</td><td>" + myres.getString("deptname") 
                                    + "</td><td>" + myres.getString("coursename") + "</td>"
                                            + "<td>"+myres.getString("year") + " Years"+"</td>"
                                            + "<td>"+myres.getString("sems") + " Semesters"+"</td>");
                                     out.print("<td><a  href='updatecourse.jsp?id=" + myres.getString("courseid")+ "'><i  class='fa-2x  fa fa-edit' style='color:blue' ></i></a></td>"
                                            +"<td><a class='mylink' id='" + myres.getString("deptid") + "' href='delcat.jsp'><i class='fa-2x fa fa-times-circle-o' style='color:red' aria-hidden='true'></i></a></td></tr>");
