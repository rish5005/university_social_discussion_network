            ...
            <div class="w3-container w3-padding">
              ...
              <span>
                ...
                <div id="selectedFiles"></div>
                              ...
                              <% 
    String message="",path="",image1="",postpics="",rno1234="";
      ...
      for(FileItem myitem:items)
        {
           ...
           else
           {
                   ...
                   long size1 =myitem.getSize()/1024; //kbytes
                   if(size1==0)
                   {
                           ...
                           || type.equals("image/gif")) && size1<10000)
                        {
      ...
      if(successful==true)
        {
          ...
          try{
                           ...
                           try{
                               ...
                               if(myres112.next())
                               {
                                   rno1234 = myres112.getString("dept");
                               }
                               

                               }
                           catch(Exception e){
                           out.print("error in getting dept");
                           }
                           try{
                              ...
                              mystatement.setString(1, rno1234); 
                               ...
                               mystatement.setString(5, session.getAttribute("rno").toString());
                               mystatement.setString(6, session.getAttribute("image").toString());
                               
                               if(mystatement.executeUpdate()>0)
                               {
                                   out.print("Posted Succesfully");
...
%>
    ...
    {           
      String user4 = "root";
                            ...
                            try
        {
            String q98="select * from rusers where rno=?";
            PreparedStatement mystatement98=myconnection.prepareStatement(q98);   
            mystatement98.setString(1, session.getAttribute("rno").toString());
            
            ResultSet myresult98 = mystatement98.executeQuery();
            if(myresult98.next())
            {
                fa = myresult98.getString("dept");
            }
