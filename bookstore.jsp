		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
						...
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
							        <li><a href="add_admin.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Admin</a></li>
                                                                ...
                                                                <li><a href="add_class.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Class</a></li>
                                                                ...
                                                                <li><a href="remove_department.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Department</a></li>
                                                                <li><a href="remove_class.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Class</a></li>
                                                                <li><a href="remove_class.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Section</a></li>
                                                                <li><a href="remove_teacher.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Teacher</a></li>
								<li><a href="remove_student.jsp"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Student</a></li>
								<li><a href="maps.html"><i class="fa fa-map-o" aria-hidden="true"></i> Maps</a></li>
                                                                <li><a href="stats.jsp"><i class="fa fa-map-o" aria-hidden="true"></i> Statistics</a></li>								
                                                        </ul>
						</div><!-- /gn-scroller -->
					</nav>
				</li>
				...
				<li class="second top_bell_nav">
				   <ul class="top_dp_agile ">
				       <li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-book"></i><span class="badge blue"></span></a>
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Book Store</h3>
											...
											<li><a href="bookstore.jsp">
												<div class="task-info">
													<span class="task-desc"><i class="fa fa-shopping-cart"></i>Buy Books</span><span class="percentage"></span>
													<div class="clearfix"></div>	
												</div>
											...
											<li><a href="#">
												<div class="task-info">
													<span class="task-desc"><i class="fa fa-truck"></i>Your Orders</span><span class="percentage"></span>
												   <div class="clearfix"></div>	
												</div>
											...
											<li><a href="#">
												<div class="task-info">
													<span class="task-desc"><i class="fa fa-list"></i>Orders Received</span><span class="percentage"></span>
													<div class="clearfix"></div>	
												</div>
    ...
    <%
        ...
        String place4 = "community";
           ...
           try{
                            ...
                            String query1="select * from bookstable";
                      ...
                      for(int i=0;i<rno_array.length;i++)
                      {
                              ...
                              out.print("<div class='w3-col m3'>"
                                  ...
                                  +"<a href='profile.jsp?rno="+rno_array[i]+"'><p class='w3-center'><img src='teacher_pics/"+image[i]+"' class='w3-circle' style='height:106px;width:106px' </p></a>" 
                                  +"<hr>"
                                  +"<h5 class='w3-center'>"+deptname[i]+"</h5>"
                                  +"<a href='profile.jsp?rno="+rno_array[i]+"'><button class='btn btn-group-justified'>View Profile</button></a>"
                                  +"</div>"
                                  +"</div>"
                                  +"</div>"
                                  +"</div>");
