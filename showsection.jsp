					...
					<%
                        ...
                        { 
                         ...
                         String place = "community";
                            ...
                            String query="select * from sectable, depttable, coursetable where sectable.deptid=depttable.deptid and sectable.courseid=coursetable.courseid order by depttable.deptid ";
                            ...
                            if(myres.next())
                            {
                                    out.print("<div class='w3l-table-info agile_info_shadow'>"
                                            + "<table class='table'>"
                                    + "<tr><th>Sr. No.</th><th>Department Name</th><th>Course Name</th><th>Admission Year</th><th>Section Name</th>"
                                ...
                                do
                                {
                                    ...
                                    out.print("<tr><td>" +count +"</td><td>" + myres.getString("deptname")+"</td>"
                                            + "<td>"+myres.getString("coursename") +"</td>"
                                             + "<td>"+myres.getString("admisyear") +"</td>"
                                            + "<td>"+myres.getString("sec") +"</td>");
                                            
                                            
                                     out.print("<td><a  href='updatesection.jsp?id=" + myres.getString("sectid")+ "'><i  class='fa-2x  fa fa-edit' style='color:blue' ></i></a></td>"
                                            +"<td><a class='mylink' id='" + myres.getString("sectid") + "' href='delcat.jsp'><i class='fa-2x fa fa-times-circle-o' style='color:red' aria-hidden='true'></i></a></td></tr>");
