...
String place = "community";
                                                                                    try{
                                                                                        ...
                                                                                        myconnection=DriverManager.getConnection(path+place,user,pass); String query101="select * from subtable where subid=?";
                                    ...
                                    {
                                        String q1="update subtableset deptid=?,courseid=?,sem=?,subname=?,credits=?,subcode=?,type=? where subid=?)";
                                       ...
                                       myst02.setString(8, request.getParameter("id"));
