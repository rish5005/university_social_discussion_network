                    ...
                    if(request.getParameter("comsub")!=null && request.getParameter("pid")!=null)
                    {
                        String user4 = "root";
                            ...
                            if(!request.getParameter("comment").trim().equals(""))
                            {
                               ...
                               try
                                {
                                    String qc="insert into commenttable(postid,type,comment,time,userid) values(?,?,?,?,?)";
                                       ...
                                       mystatement41.setInt(1, Integer.parseInt(request.getParameter("pid")));
                                        mystatement41.setString(2,"admin" );
                                       mystatement41.setString(3, request.getParameter("comment"));
                                       

                                        java.util.Date dat=new java.util.Date();
                                       mystatement41.setString(4, dat.toString());

                                       mystatement41.setString(5, session.getAttribute("email").toString());
                                    if(mystatement41.executeUpdate()>0)
                                    {   
                                        
                                        response.sendRedirect("comment_a.jsp?pid="+ request.getParameter("pid"));
                                    }
                                }
                                catch(Exception e)
                                {
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <%
             ...
             try{
                           ...
                           try{
                               ...
                               String q112="select * from admintable where email=?";
                               PreparedStatement mystatement112=myconnection.prepareStatement(q112);
                               mystatement112.setString(1, session.getAttribute("email").toString());
         ...
         out.print("<p><i class='fa fa-envelope fa-fw w3-margin-right w3-text-theme'></i>"+ emili +"</p>");
         %>
        </div>
      </div>
      <br>
        ...
        <div class="w3-white">
         ...
         <%
                            ...
                            try
            {
                ...
                mystatement.setString(1, "admin");
                mystatement.setString(2, session.getAttribute("email").toString() );
                                            ...
                                            if(myresult3.getInt("totalpics")==1)
                                            {
                                                if(myresult.getString("type").equals("admin"))
                                                {
                                                    ...
                                                    if(myresult4.next())
                                                    {
                                                        ...
                                                        out.print("</div>");
                                                        if(myresult.getString("userid").equals(session.getAttribute("email").toString()) && myresult.getString("type").equals("admin"))
                                                        {
