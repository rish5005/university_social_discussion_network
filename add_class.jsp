...
<div class="wthree_agile_admin_info">
        ...
        try{
             ...
             try{
                 ...
                 String query1="insert into coursetable(deptid,coursename,year,sems) values(?,?,?,?)";
                 PreparedStatement myst1=myconnection.prepareStatement(query1);
                 myst1.setString(1,request.getParameter("deptbox"));
                 myst1.setString(2,request.getParameter("coursename"));
                 myst1.setString(3,request.getParameter("courselen"));
                 myst1.setString(4,request.getParameter("sems"));
