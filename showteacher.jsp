					...
					<%
                        ...
                        { 
                         ...
                         String place = "community";
                            ...
                            String query="select * from teachertable, depttable where teachertable.deptid=depttable.deptid ";
                            ...
                            if(myres.next())
                            {
                                    out.print("<div class='w3l-table-info agile_info_shadow'>"
                                            + "<table class='table'>"
                                    + "<tr><th>Sr. No.</th><th>Department Name</th><th>Teacher name</th><th>Email</th><th>Qualification</th><th>Designation</th>"
                                    + "<th>Phone No.</th><th>Gender</th><th>Date Of Birth</th><th>Update</th><th>Delete</th></tr>");

                                do
                                {
                                   
                                    out.print("<tr><td>" +count +"</td><td>" + myres.getString("deptname") 
                                    + "</td><td><img src='teacher_pics/"+myres.getString("image")+"' width='60px' height='60px'><br>" + myres.getString("name") + "</td>"
                                            + "<td>"+myres.getString("email") +"</td>"
                                            + "<td>"+myres.getString("qualification") +"</td>"
                                            + "<td>"+myres.getString("desig") +"</td>"
                                            + "<td>"+myres.getString("phone") +"</td>"
                                            + "<td>"+myres.getString("gender") +"</td>"
                                            + "<td>"+myres.getString("dob") +"</td>");
                                            
                                     out.print("<td><a  href='updateteacher.jsp?id=" + myres.getString("teacherid")+ "'><i  class='fa-2x  fa fa-edit' style='color:blue' ></i></a></td>"
                                            +"<td><a class='mylink' id='" + myres.getString("teacherid") + "' href='delcat.jsp'><i class='fa-2x fa fa-times-circle-o' style='color:red' aria-hidden='true'></i></a></td></tr>");
