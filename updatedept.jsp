...
<!-- banner -->
        ...
        if(request.getParameter("submit")!=null){
         ...
         try{
             ...
             try
                    {
                        String q="update depttable set deptname=?, mneo=? where deptid=?" ;
                        PreparedStatement mystatement=myconnection.prepareStatement(q);
                        mystatement.setString(1, request.getParameter("deptname"));
                        mystatement.setString(2, request.getParameter("deptmneo"));
                        mystatement.setString(3, request.getParameter("id"));
                        
                        if(mystatement.executeUpdate()>0)
                        {   
                          //  out.print("Data Updated Successfully");
                            response.sendRedirect("showdept.jsp");
                        }
                    }
                    catch(Exception e)
                    {
									...
									<div class="form-body form-body-info">
										<form method="post">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="deptname" placeholder="Department Name" required="">
											</div>
                                                                                    <div class="form-group">
                                                                                            
												<input type="text" class="form-control" name="deptmneo" placeholder="Department Mnemonic(CSE,ECE etc)" required="">
											</div>
											<div class="form-group">
