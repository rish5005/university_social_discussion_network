                                                                                                                ...
                                                                                                                try{
                                                                                                                    ...
                                                                                                                    try{
                                                                                                                        ...
                                                                                                                        if(rs.next())
                                                                                                                        {
                                                                                                                             ...
                                                                                                                             String query01="select * from coursetable where courseid=?";
                                                                                                                        PreparedStatement myst01=myconnection.prepareStatement(query01);
                                                                                                                        myst01.setString(1, courseid);
                                                                                                                        ResultSet rs1 = myst01.executeQuery();
                                                                                                                        if(rs1.next())
                                                                                                                        {
                                                                                                                            int sems = Integer.parseInt(rs1.getString("sems"));
                                                                                                                            for(int i=1;i<=sems;i++)
                                                                                                                            {
                                                                                                                               out.print("<option value='"+i+"'>"+"Semester-"+i+"</option>");
                                                                                                                            }
