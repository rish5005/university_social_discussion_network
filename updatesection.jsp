...
<%
        if(request.getParameter("sub")!=null){
            if(request.getParameter("deptbox").trim().equals("") || request.getParameter("coursename").trim().equals("") || request.getParameter("admisyear").trim().equals("") || request.getParameter("sec").trim().equals(""))
            {
...
String place = "community";
                                                                                    try{
                                                                                        ...
                                                                                        myconnection=DriverManager.getConnection(path+place,user,pass);
                                                                                                                        ...
                                                                                                                        String query0="update sectable set deptid=?,courseid=?,admisyear=?,sec=? where sectid=?";
                                                                                                                        PreparedStatement myst0=myconnection.prepareStatement(query0);
                                                                                                                        myst0.setString(1,request.getParameter("deptbox"));
                                                                                                                        myst0.setString(2,request.getParameter("coursename"));
                                                                                                                        myst0.setString(3,request.getParameter("admisyear"));
                                                                                                                        myst0.setString(4,request.getParameter("sec"));
                                                                                                                        myst0.setString(5,request.getParameter("id"));
                                                                                                                        if(myst0.executeUpdate()>0)
                                                                                                                        {
                                                                                                                            response.sendRedirect("showsection.jsp");
                                                                                                                        }
                                                                                                                        else
                                                                                                                        {
                                                                                                                            out.print(request.getParameter("sec")+"not added successfully");
                                                                                                                        }
								...
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									<div class="form-body form-body-info">
										...
										<div class="form-group ">	
												...
												<input type="text" class="form-control" name="admisyear" placeholder="Addmission Year(2014,2015)" required>
											</div>
											
                                                                                            <div class="form-group ">
                                                                                            
												<input type="text" class="form-control" name="sec" placeholder="Section Name(Sec-A,Sec-B)" required>
											</div>
