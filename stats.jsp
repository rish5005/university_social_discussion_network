...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								<li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Admin</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Department</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Class</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Section</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Teacher</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Subjects</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Assign Teachers</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Department</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Class</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Section</a></li>
                                                                <li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Teacher</a></li>
								<li><a href="#"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Remove Student</a></li>
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main_page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Esteem </a></h1></li>
