...
<link rel="stylesheet" href="css1/c2.css">
<link rel="stylesheet" href="css1/c4.css">
...
<div class="wthree_agile_admin_info">
        ...
        <img src="images2/avatar2.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half">
              <img src="images2/lights.jpg" style="width:100%" alt="Northern Lights" class="w3-margin-bottom">
            </div>
            <div class="w3-half">
              <img src="images2/nature.jpg" style="width:100%" alt="Nature" class="w3-margin-bottom">
          </div>
        </div>
...
<!-- Right Column -->
    <div class="col-md-3">
      <div class="w3-card w3-round w3-animate-top w3-cell-top w3-center">
      ...
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          <p>Friend Request</p>
          <img src="images2/avatar2.png" alt="Avatar" style="width:50%"><br>
          <span>Jane Doe</span>
