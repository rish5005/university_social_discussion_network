           ...
           try{
                      ...
                      for(int i=0;i<rno_array.length;i++)
                      {
                              ...
                              out.print("<div class='w3-col m3'>"
                                  ...
                                  +"<a href='profile_a.jsp?rno="+rno_array[i]+"'><p class='w3-center'><img src='teacher_pics/"+image[i]+"' class='w3-circle' style='height:106px;width:106px' </p></a>" 
                                  +"<hr>"
                                  +"<h5 class='w3-center'>"+deptname[i]+"</h5>"
                                  +"<a href='profile_a.jsp?rno="+rno_array[i]+"'><button class='btn btn-group-justified'>View Profile</button></a>"
                                  +"</div>"
                                  +"</div>"
                                  +"</div>"
                                  +"</div>");
